 ...
 * /customers/{CUST_CODE}:
 *   get:
 *     summary: Retrieve a customer by {CUST_CODE}.
 *     tags: [Customers]
 *     parameters:
 *       - in: path
 *         name: CUST_CODE
...
app.get('/customers/:CUST_CODE', async (req, res) => {
        const custCode = req.params.CUST_CODE;
 ...
 *         description: Database error.
 */
app.post('/agents/create', postValidation, async (req, res) => {
...
// Define validation and sanitation middleware for DELETE
 ...
 *         description: Database error.
 */
app.delete('/agents/delete/:AGENT_CODE', deleteValidation, async (req, res) => {
